...
void AGraduationProjectCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		EnhancedInputComponent->BindAction(MouseLookAction, ETriggerEvent::Triggered, this, &AGraduationProjectCharacter::Look);
	...
	{
		UE_LOG(LogGraduationProject, Error, TEXT("'%s' Failed to find an Enhanced Input component! This template is built to use the Enhanced Input system. If you intend to use the legacy system, then you will need to update this C++ file."), *GetNameSafe(this));
	}
}
...
void AGraduationProjectCharacter::DoMove(float Right, float Forward)
{
...
void AGraduationProjectCharacter::DoLook(float Yaw, float Pitch)
{
	if (GetController() != nullptr)
	{
...
void AGraduationProjectCharacter::DoJumpStart()
{
	// signal the character to jump
	Jump();
}

void AGraduationProjectCharacter::DoJumpEnd()
{
